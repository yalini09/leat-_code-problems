class Solution {
    public int[] pathExistenceQueries(int n, int[] nums, int maxDiff, int[][] queries) {
        ...
        // Now I know all which are connected. 

        // Now I need to tell, from curr index How far I cna reach? 
        int[] next = new int[n]; 
        int l = 0, r = 0; 
        while(l < n) {
        ...
        // Now we will sue the binary lifting 
        ...
        for(int i = 0; i < q; i++) {
            ...
            // for each these index, find their mapping
            ...
            int jumps = 0; 
            // Now we have to find from the precomputed tables. 
            for(int base = k - 1; base >= 0; base--) {
                // what it means? from node mapL -> where can I react in 2 ^ i jumps? 
